...
STATIC = {
    ...
    # 빈 문서 골격을 인라인한 것. `file://` 에서 AI 문서 한글 내보내기의 유일한 경로다.
    "/blank-template-data.js": ("blank-template-data.js", "application/javascript; charset=utf-8"),
    ...
    # 사진 AI의 이미지 전처리·응답 문항 변환. 본체가 classic script로 즉시 읽는다.
    "/pedagogy-ai-image.js": ("pedagogy-ai-image.js", "application/javascript; charset=utf-8"),
