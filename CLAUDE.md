...
들어와 다섯 가지를 고쳤고(테두리·각주·선지 배치·문단 들여쓰기·**순서 문항 (A)(B)(C) 라벨**),
**남은 네 개는 설계까지 끝나 있다** — 근거·계약·고칠 곳·위험이 그 문서에 적혀 있으니
그대로 실행하면 된다. 권하는 순서: ④ 듣기 답란 → ⑤ 묶음 안내 → ③ 안내문 상자.
...
(무테 지문·각주 우측 정렬·2열 선지·(A)(B)(C) 인라인 라벨)를 지킨다. 지우지 말 것.
