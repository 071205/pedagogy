...
들어와 일곱 가지를 고쳤고(테두리·각주·선지 배치·문단 들여쓰기·순서 문항 (A)(B)(C) 라벨·
듣기 답란·**지문 없는 묶음 안내**), **남은 두 개는 설계까지 끝나 있다** — 근거·계약·
고칠 곳·위험이 그 문서에 적혀 있으니 그대로 실행하면 된다. 다음은 ③ 안내문 상자.
곁가지로 **대화문 말한이와 묶음 안내 줄이 실물에서 굵지 않다**는 것을 확인해 뒀다(그 문서 §6).
...
(무테 지문·각주 우측 정렬·2열 선지·(A)(B)(C) 인라인 라벨·듣기 답란 밑줄·묶음 안내)를 지킨다.
지우지 말 것.
